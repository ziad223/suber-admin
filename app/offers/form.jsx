...
export default function Form_Product({ id }) {
  ...
  const [fields, setFields] = useState([
    { id: 1, product_id: "", quantity: "1", is_gift: "0" },
    { id: 2, product_id: "", quantity: "1", is_gift: "0" },
  ]);
  ...
  const handleAddFields = () => {
    setFields([...fields, { id: Math.random(), product_id: "", quantity: "1", is_gift: "0" }]);
  };
  ...
  const default_item = () => {
    setData({
      ...
      products: fields.map(field => ({
        ...
        is_gift: parseInt(field.is_gift, 10) || 0
      }))
  ...
  const get_item = async () => {
    ...
    try {
      const response = await fetch(
        `https://sahl.future-developers.cloud/api/admin/offers/show/${id}`,
        {
          headers: headers,
          method: "GET",
        }
  ...
  product.products.map((item) => ({
    ...
    is_gift: item.is_gift,
      ...
      if (!product?.id) return router.replace("/offers");
  ...
  const save = async () => {
    ...
    const url = id ? `admin/offers/update/${id}` : "admin/offers/create";
                  ...
                  <div className="div-2 mb-4 w-full lg:w-1/2 ltr:lg:mr-6 rtl:lg:ml-6">
                    ...
                    <div className="relative flex items-center mt-4 md:mt-4">
                     ...
                     <label
                      ...
                      >
                        <option value="bundle_discount">bundle_discount</option>
                        <option value="buy_x_get">buy_x_get</option>
                      </select>
                    </div>
       ...
       <div>
         ...
         <div>
           ...
           <select
                        ...
                        name="is_gift"
                        value={field.is_gift || ''}
                        onChange={(e) => handleChange(field.id, "is_gift" , e.target.value)}
          ...
          >
            Delete
              ...
              <SelectProduct
                ...
                category
                onChange={(id, name) => {
                  handleChange(fieldSelected , "product" ,  { name: name, id: id });
                }}
              />
            </div>
