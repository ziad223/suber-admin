...
export default function Form_Reply ({ config, data, setData, save, products, model, setModel, loader }) {
                                ...
                                <form className="p-5 mt-2">
                                    ...
                                    <div className='flex justify-between lg:flex-row flex-col'>
                                        ...
                                        <div className='w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6 relative'>
                                            ...
                                            <input id="product" type="text" value={data.product?.name || '-'} onClick={() => setProductMenu(true)} className={`form-input flex-1 ${data.id ? 'default' : 'pointer'}`} readOnly/>
                                        </div>
