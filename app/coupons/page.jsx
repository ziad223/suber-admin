"use client";
import { api, date as dt, alert_msg, matching, fix_date, print, fix_number } from '@/public/script/public';
...
export default function Coupons () {
    ...
    const columns = () => {
        ...
        return [
            ...
            {
                accessor: 'name', sortable: true, title: 'coupon',
                render: ({ name, id }) => (
                    <div className="flex items-center font-semibold default">
                        ...
                        <div className="font-semibold select-text truncate max-w-[20rem]">{name}</div>
                    </div>
                ),
            },
            {
            ...
            },
            {
                ...
                render: ({ uses, id }) => <div className="font-semibold select-text default">{fix_number(uses)}</div>
            },
            {
    ...
    const delete_ = async( ids ) => {
        ...
        await api('coupon/delete', {ids: JSON.stringify(ids)});
